...
<body>
  ...
  <a class="navbar-brand text-center" href="#" > Contact us </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link active  href="#">Call us: +9779863039019</a>
      </li>
...
<div class="body-content" >
  ...
  <form class="form" action="connect.php" method="POST" style="margin-top: 35px;">
...
<p><a href="mailto:schindrathakur570@gmail.com" title="glorythemes">sachindrathakur570@gmail.com</a></p>
