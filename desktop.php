...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v6.0"></script>
  ...
  <b><a class="navbar-brand active  text-light " href="Homepage.php" > Mobile App Development </a></b>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link active text-light" href="Homepage.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item text-dark" href="web.php">BANK</a>
          <a class="dropdown-item text-dark" href="desktop.php">RESTURANT</a>
          <a class="dropdown-item text-dark" href="mobileapp.php"> HOSPITAL</a>
        </div>
      </li>
      <li class="nav-item">
...
<div class="container-fluid t ">
  ...
  <div class="card-body">
    <h4 class="card-title">SENIOR WEB DEVELOPER</h4>
    <p class="card-text">ALOK MISHRA</p>
    <a href="https://www.facebook.com/profile.php?id=100013605604929&epa=SEARCH_BOX" class="btn btn-primary">Learn More</a>
  </div>
</div>
       </div>
        <div class="col-lg-4 col-md-4 col-12">
      <div class="card" style="width:400px" >
  <img class="card-img-top  img-fluid" src="Images/pramod.jpg" alt="Card image " style="height: -20px">
  <div class="card-body">
    <h4 class="card-title">Backend DEVELOPER</h4>
    <p class="card-text">PRAMOD BHATTRAI</p>
    <a href="https://www.facebook.com/pramod.bhattarai.798" class="btn btn-primary">Learn More</a>
  </div>
</div>
       </div>
        <div class="col-lg-4 col-md-4 col-12">
      <div class="card" style="width:400px">
  <img class="card-img-top" src="Images/sachindra.jpg" alt="Card image">
  <div class="card-body">
    <h4 class="card-title">FULL STACK DEVELOPER</h4>
    <p class="card-text">SACHINDRA THAKUR</p>
    <a href="https://www.facebook.com/" class="btn btn-primary">Learn More</a>
  </div>
...
<h5 class="widget-title">DEVELOPER NEPAL<span></span></h5>
<p>bhaktapur 10 Nepal </p>
</div>
</div>
...
<p>Get access to your dream.</p>
<a class="btn" href="form.php" target="_blank">JOIN Now</a>
</div>
</div>
...
<p><a href="mailto:sachindrathakur570@gmail.com" title="glorythemes">sachindrathakur570@gmail.com</a></p>
...
<p>Copyright DEVELOPER NEPAL © 2020. All rights reserved.</p>
</div>
</div>
</div>
</div>
